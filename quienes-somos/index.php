...
<!--    <section class="top-space-margin page-title-big-typography border-radius-6px lg-border-radius-0px p-0" data-parallax-background-ratio="0.5"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center small-screen">
                <div class="col-lg-8 position-relative text-center page-title-extra-large"
                    ...
                    <h1 class="m-auto text-white text-shadow-double-large fw-600 ls-minus-2px">Acerca de nosotros</h1>
                </div>
        ...
        <div class="container overlap-gap-section">
            <div class="row align-items-end justify-content-center mb-5 md-mb-40px text-center text-md-start">
                <div class="col-xl-5 col-lg-6 col-md-10 md-mb-20px text-center text-lg-start"
                    ...
                    <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Nuestra historia</span>
                    <h3 class="text-dark-gray fw-700 mb-0 ls-minus-1px">¡La supervisión es la clave de nuestro éxito!</h3>
                </div>
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 row-cols-sm-2 justify-content-center"
                ...
                <div class="col custom-icon-with-text-style-02">
                    <div class="feature-box p-6 last-paragraph-no-margin overflow-hidden md-mb-20px">
                        <div class="feature-box-icon pb-4">
                            <i class="fa-regular fa-thumbs-up align-middle icon-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span class="d-block fs-19 fw-700 text-dark-gray mb-5px">Calidad</span>
                            <p class="lh-sm">Brindamos soluciones eficientes y de excelente calidad a nuestros clientes.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col custom-icon-with-text-style-02">
                    <div class="feature-box p-6 last-paragraph-no-margin overflow-hidden md-mb-20px">
                        <div class="feature-box-icon pb-4">
                            <i class="fa-solid fa-handshake-angle align-middle icon-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span class="d-block fs-19 fw-700 text-dark-gray mb-5px">Servicio</span>
                            <p class="lh-sm">Con nuestro servicio buscamos construir ambientes limpios, higiénicos y agradables.</p>
                        </div>
                    </div>
                </div>
                <!-- end features box item -->
                ...
                <div class="col custom-icon-with-text-style-02">
                    <div class="feature-box p-6 last-paragraph-no-margin overflow-hidden xs-mb-20px">
                        <div class="feature-box-icon pb-4">
                            <i class="fa-solid fa-arrow-trend-up align-middle icon-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span class="d-block fs-19 fw-700 text-dark-gray mb-5px">Mejoramiento continuo</span>
                            <p class="lh-sm">Nos esforzamos en el mejoramiento continuo de nuestra actividad.</p>
                        </div>
                    </div>
                </div>
                <!-- end features box item -->
                ...
                <div class="col custom-icon-with-text-style-02">
                    <div class="feature-box p-6 last-paragraph-no-margin overflow-hidden">
                        <div class="feature-box-icon pb-4">
                            <i class="fa-solid fa-leaf align-middle icon-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span class="d-block fs-19 fw-700 text-dark-gray mb-5px">Productos sostenibles</span>
                            <p class="lh-sm">Utilizamos productos amigables con el medio ambiente.</p>
                        </div>
                    </div>
                </div>
                <!-- end features box item -->
                ...
                <div class="col-auto text-center last-paragraph-no-margin icon-with-text-style-08 pt-20px pb-20px ps-8 pe-8 md-ps-30px md-pe-30px bg-white border border-color-extra-medium-gray box-shadow-medium-bottom border-radius-100px xs-border-radius-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin text-dark-gray text-uppercase fs-15 fw-700 ls-05px">
                            Solicita una cotización <a href="/contacto/" class="text-base-color text-decoration-line-bottom-medium border-1">ahora</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-12 text-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <h2 class="fw-700 text-dark-gray ls-minus-1px mb-25px d-block">Nuestra historia</h2>
                </div>
            </div>
    ...
    <section class="position-relative overflow-hidden">
            ...
            <div class="row justify-content-center align-items-center mb-3">
                <div class="col-xl-5 col-lg-6 md-mb-14 sm-mb-18 xs-mb-23 position-relative"
                    ...
                    <div class="w-75 sm-w-80" data-animation-delay="200" data-shadow-animation="true" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                        <img src="https://placehold.co/600x710" alt="" class="border-radius-6px w-100">
                        <div class="position-absolute top-30px z-index-8 left-minus-90px lg-left-minus-25px sm-left-minus-0px lg-w-30">
                            <img src="/img/experiencia-10.png" alt="Más de 10 años de experiencia"/>
                        </div>
                    </div>
                    <div class="w-55 overflow-hidden position-absolute right-15px xs-w-55 bottom-minus-50px" data-shadow-animation="true" data-animation-delay="100"
                         data-bottom-top="transform: translateY(20px)" data-top-bottom="transform: translateY(-20px)">
                        <img src="https://placehold.co/600x633" alt="" class="border-radius-6px box-shadow-quadruple-large w-100"/>
                    </div>
                </div>
                <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-lg-start"
                    ...
                    <div class="swiper position-relative magic-cursor"
                        ...
                        <div class="swiper-wrapper mb-10px">
                            ...
                            <!-- start text slider item -->
                            <div class="swiper-slide">
                                <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Visión</span>
                                <h3 class="text-dark-gray fw-700 ls-minus-1px mb-20px">Empresa líder en soluciones integrales de limpieza.</h3>
                                <p class="w-95 xl-w-100">Consolidarnos y ser reconocidos a nivel nacional, como una empresa líder en soluciones integrales de limpieza, mantenimiento y afines, a través
                                    de procesos eficaces, con un equipo humano capacitado y apasionado por el servicio, priorizando la generación de empleo a madres cabeza de familia, afianzando el
                                    crecimiento empresarial y la fidelización de nuestros clientes.</p>
                            </div>
                            <!-- end text slider item -->
                            <!-- start text slider item -->
                            <div class="swiper-slide">
                                <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Valores</span>
                                <h3 class="text-dark-gray fw-700 ls-minus-1px mb-20px">Crecemos con responsabilidad, innovamos con propósito.</h3>
                                <p class="w-95 xl-w-100">
                                <ul class="list-group list-group-flush lh-sm valores">
                                    <li class="list-group-item"><strong>Vocación de servicio:</strong> Se refleja en nuestra actitud de servir con amabilidad, respeto y responsabilidad a nuestros
                                        clientes.
                                    </li>
                                    <li class="list-group-item"><strong>Honestidad:</strong> Hablamos y actuamos con sinceridad y transparencia.</li>
                                    <li class="list-group-item"><strong>Respeto:</strong> Nos preocupamos por el impacto que nuestras acciones y palabras puedan tener en los demás.</li>
                                    <li class="list-group-item"><strong>Responsabilidad:</strong> Actuamos con el compromiso de desempeñar a cabalidad nuestras actividades propias del cargo y
                                        responder a la confianza que los demás depositen
                                        en nosotros.
                                    </li>
                                    <li class="list-group-item"><strong>Calidad:</strong> Generamos cultura y métodos de trabajo, que nos orientan en la forma de pensar y desarrollar nuestro trabajo.
                                    </li>
                                </ul>
                                </p>
                            </div>
                        ...
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            ...
                            <div class="slider-one-slide-prev-1 swiper-button-prev slider-navigation-style-04 border border-color-extra-medium-gray bg-white"><i
                                        class="bi bi-arrow-left-short icon-very-medium text-dark-gray"></i></div>
                            <div class="slider-one-slide-next-1 swiper-button-next slider-navigation-style-04 border border-color-extra-medium-gray bg-white"><i
                                        class="bi bi-arrow-right-short icon-very-medium text-dark-gray"></i></div>
        ...
        <img src="/img/about-bg-01.webp" class="position-absolute bottom-minus-50px right-minus-50px z-index-minus-1" data-bottom-top="transform: rotate(0deg) translateY(0)"
    ...
    <section class="bg-gradient-quartz-white border-radius-6px">
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-xl-5 col-md-7 col-lg-6 col-sm-8 text-center"
                     data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2"
                ...
                <div class="col team-style-08 border-radius-6px md-mb-30px">
                    <figure class="mb-0 position-relative overflow-hidden border-radius-4px">
                        <img src="https://placehold.co/600x755" alt=""/>
